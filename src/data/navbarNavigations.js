...
if (typeof window !== "undefined" && localStorage.getItem("buyerId")) {
  navbarNavigations.push(userAccount);
} else if (typeof window !== "undefined" && localStorage.getItem("vendorId")) {
  navbarNavigations.push(vendorAccount);
}
